...
local function updateMap()
    ...
    lib.notify({title = 'Krs Hud', icon = 'fa-solid fa-earth-americas', description = 'Map Loading...', type = 'inform'})
    ...
    lib.notify({title = 'Krs Hud', icon = 'fa-solid fa-earth-americas', description = 'Map Has Loaded!', type = 'inform'})
end
